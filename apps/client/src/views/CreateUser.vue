...
import { sweetAlert } from '@/utils/useSweetAlert'
...
const zoom = ref(15)
const center = ref<[number, number]>([20.6767, -103.3475]);
const markerPosition = ref<[number, number]>([20.6767, -103.3475]);
const address = ref('')
